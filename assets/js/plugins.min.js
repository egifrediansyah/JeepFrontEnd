...
!function (e, t) {
    ...
    function a() {
        ...
        return !e && d.implementation && d.implementation.hasFeature && !0 !== d
            .implementation
            .hasFeature("", "") && (e = d.implementation.hasFeature("Events.wheel", "3.0")),
        e
    }
    var i,
            ...
            for (var c, u = n.split(" "), h = 0; h < this.length; h += 1) {
                ...
                if (o) 
                    for (c = 0; c < u.length; c += 1) 
                        ...
                        v
                            .dom7LiveListeners
                            .push({type: n, listener: l, proxyListener: t}),
                    ...
                    for (c = 0; c < u.length; c += 1) 
                        ...
                        v
                            .dom7Listeners
                            .push({type: n, listener: l, proxyListener: a}),
                        ...
                        if (c.dom7LiveListeners) 
                            for (var u = 0; u < c.dom7LiveListeners.length; u += 1) 
                                r
                                    ? c
                                        .dom7LiveListeners[u]
                                        .listener === r && c.removeEventListener(
                                            l[d],
                                    ...
                                    : c
                                        .dom7LiveListeners[u]
                                        .type === l[d] && c.removeEventListener(
                                            l[d],
                                            c.dom7LiveListeners[u].proxyListener,
                                            n
                                        )
    ...
    var o,
                ...
                if ("string" == typeof o && o.length) 
                    for (r = (a = (
                        ...
                        i = a[t]
                            .replace(/#\S+/g, "")
                            .split("="),
                        n[decodeURIComponent(i[0])] = void 0 === i[1]
                            ? void 0
        ...
        d = o = "undefined" == typeof document
            ...
            : document,
        p = {
            touch: s.Modernizr && !0 === s.Modernizr.touch || !!(
                "ontouchstart" in s || s.DocumentTouch && d instanceof s.DocumentTouch
            ),
    ...
    c.prototype.emit = function () {
        ...
        var i,
            s,
            r;
        return "string" == typeof e[0] || Array.isArray(e[0])
    ...
    var h = {
            ...
            updateSlides: function () {
                ...
                if (void 0 !== i) {
                    ...
                    var T;
                    t.slidesPerColumn > 1 && (
                        T = Math.floor(o / t.slidesPerColumn) === o / e.params.slidesPerColumn
                            ? o
                    ...
                    if (!t.centeredSlides) {
                        ...
                        d = L,
                        Math.floor(e.virtualSize - i) - Math.floor(d[d.length - 1]) > 1 && d.push(
                            e.virtualSize - i
                        )
                    }
                    0 === d.length && (d = [0]),
                ...
                if (0 !== i.length) {
                    ...
                    for (var n = 0; n < i.length; n += 1) {
                        ...
                        if (a.watchSlidesVisibility) {
                            ...
                            (d >= 0 && d < t.size || p > 0 && p <= t.size || d <= 0 && p >= t.size) && i
                                .eq(
                                    n
                                )
            ...
            updateSlidesClasses: function () {
                ...
                t.removeClass(
                    a.slideActiveClass + " " + a.slideNextClass + " " + a.slidePrevClass + " " + a.slideDuplicateActiveClass +
                ...
                a.loop && (
                    o.hasClass(a.slideDuplicateClass)
                        ? i.children(
                            "." + a.slideClass + ":not(." + a.slideDuplicateClass + ')[data-swiper-slide-in' +
                            'dex="' + r + '"]'
            ...
            updateActiveIndex: function (e) {
                ...
                if ((
                    t = r.indexOf(i) >= 0
                        ? r.indexOf(i)
                        : Math.floor(c / n.slidesPerGroup)
                ) >= r.length && (t = r.length - 1), c !== o) {
            ...
            if (!s || !r) 
                ...
                a.virtual && a.params.virtual.enabled
                    ? a.clickedIndex = parseInt(e(s).attr("data-swiper-slide-index"), 10)
        ...
        g = {
            ...
            return !(
                    !s.allowSlideNext && v < s.translate && v < s.minTranslate() || !s.allowSlidePrev && v > s.translate && v > s.maxTranslate() && (p || 0) !== r || (
        ...
        b = {
            ...
            loopFix: function () {
                ...
                i < r
                    ...
                    : (
                        "auto" === a.slidesPerView && i >= 2 * r || i > s.length - 2 * a.slidesPerView
        ...
        x = function () {
            ...
            if (
                ...
                t.ios && t.osVersion && e.indexOf("Version/") >= 0 && "10" === t.osVersion.split(".")[0] && (
                    t.osVersion = e.toLowerCase().split("version/")[1].split(
                        " "
                    )[0]
                ),
                t.desktop = !(t.os || t.android || t.webView),
                t.webView = (o || r || n) && e.match(
        ...
        T = function (t) {
            ...
            if (
                ...
                if (s.noSwiping && e(n.target).closest("." + s.noSwipingClass)[0]) 
                    ...
                    r.currentX = "touchstart" === n.type
                        ? n
                            .targetTouches[0]
                            .pageX
                        : n.pageX,
                    r.currentY = "touchstart" === n.type
                        ? n
                            .targetTouches[0]
                            .pageY
                        : n.pageY;
                    ...
                    if (!(x.ios && !x.cordova && s.iOSEdgeSwipeDetection && o <= s.iOSEdgeSwipeThreshold && o >= window.screen.width - s.iOSEdgeSwipeThreshold)) {
                        if (
                            ...
                            d.activeElement && e(d.activeElement).is(i.formElements) && d
                                .activeElement
                                .blur(),
                        ...
                        if (i.isScrolling) 
                            ...
                            if (
                                ...
                                f > 0 && i.currentTranslate > a.minTranslate()
                                    ? (
                                        m = !1,
                                        s.resistance && (i.currentTranslate = a.minTranslate() - 1 + Math.pow(-a.minTranslate() + i.startTranslate + f, g))
                                    )
                ...
                if (
                    ...
                    for (
                        ...
                        void 0 !== o[P + i.slidesPerGroup]
                            ? h >= o[P] && h < o[P + i.slidesPerGroup] && (
                                M = P,
                                z = o[P + i.slidesPerGroup] - o[P]
                            )
        ...
        P = {
                    ...
                    if (m.ie) 
                        ...
                        (
                            p.touch
                                ? r
                                : d
                        ).addEventListener(a.move, e.onTouchMove, n),
                        (
                            p.touch
                                ? r
                                : d
                        ).addEventListener(a.end, e.onTouchEnd, !1);
                    else {
                        if (p.touch) {
                            var o = !(
                                "touchstart" !== a.start || !p.passiveListener || !t.passiveListeners
                            ) && {
                                passive: !0,
                                capture: !1
                            };
                    ...
                    if (m.ie) 
                        ...
                        (
                            p.touch
                                ? r
                                : d
                        ).removeEventListener(a.move, e.onTouchMove, n),
                        (
                            p.touch
                                ? r
                                : d
                        ).removeEventListener(a.end, e.onTouchEnd, !1);
                    else {
                        if (p.touch) {
                            var o = !(
                                "onTouchStart" !== a.start || !p.passiveListener || !t.passiveListeners
                            ) && {
                                passive: !0,
                                capture: !1
                            };
            ...
            classes: {
                addClasses: function () {
                    ...
                    x.ios && n.push("ios"),
                    (s.navigator.pointerEnabled || s.navigator.msPointerEnabled) && n.push(
                        "wp8-" + a.direction
                    ),
                ...
                if (n = h[0]) {
                    ...
                    return l.extend(c, {
                        ...
                        touchEvents: function () {
                            ...
                            return s.navigator.pointerEnabled
                                ? t = ["pointerdown", "pointermove", "pointerup"]
                                : s.navigator.msPointerEnabled && (
                                    t = ["MSPointerDown", "MsPointerMove", "MsPointerUp"]
                                ), {
                                start: p.touch || !c.params.simulateTouch
                                    ? e[0]
                                    : t[0],
                                move: p.touch || !c.params.simulateTouch
                                    ? e[1]
                                    : t[1],
                                end: p.touch || !c.params.simulateTouch
                                    ? e[2]
                                    : t[2]
                            }
                        }(),
        ...
        N = {
            update: function (e) {
                function t() {
                    ...
                    a.lazy && a.params.lazy.enabled && a
                        .lazy
                        .load()
                }
                var a = this,
                ...
                if (e) 
                    ...
                    for (var S = d; S <= p; S += 1) 
                        (S < w || S > y) && a
                            .$wrapperEl
                            .find(
                                "." + a.params.slideClass + '[data-swiper-slide-index="' + S + '"]'
                            )
                            .remove();
            ...
            renderSlide: function (t, a) {
                ...
                var r = e(
                    s.renderSlide
                        ...
                        : '<div class="' + i.params.slideClass + '" data-swiper-slide-index="' + a +
                                '">' + t + "</div>"
                );
                return r.attr("data-swiper-slide-index") || r.attr(
                ...
                if (!(a.shiftKey || a.altKey || a.ctrlKey || a.metaKey || d.activeElement && d.activeElement.nodeName && ("input" === d.activeElement.nodeName.toLowerCase() || "textarea" === d.activeElement.nodeName.toLowerCase()))) {
                    if (37 === i || 39 === i || 38 === i || 40 === i) {
                        ...
                        for (var c = [
                            ...
                            var h = c[u];
                            h[0] >= n.left && h[0] <= n.left + o && h[1] >= n.top && h[1] <= n.top + l && (
                                r = !0
                            )
                        }
                        if (!r) 
                    ...
                    t.isHorizontal()
                        ...
                        : (38 !== i && 40 !== i || (
                            a.preventDefault
                                ? a.preventDefault()
                                : a.returnValue = !1
                        ), 40 === i && t.slideNext(), 38 === i && t.slidePrev()),
                    t.emit("keyPress", i)
                }
            },
            enable: function () {
            ...
            on: {
                ...
                click: function (t) {
                    var a = this,
                        ...
                        s = i.$nextEl,
                        r = i.$prevEl;
                    !a.params.navigation.hideOnClick || e(t.target).is(r) || e(t.target).is(s) || (
                ...
                if (i.el && t.pagination.el && t.pagination.$el && 0 !== t.pagination.$el.length) {
                    ...
                    if (
                        t.params.loop
                            ...
                            : s = void 0 !== t.snapIndex
                                ? t.snapIndex
                                : t.activeIndex || 0,
                        "bullets" === i.type && t.pagination.bullets && t.pagination.bullets.length > 0
                    ) {
                        var l = t.pagination.bullets;
                        if (i.dynamicBullets && (t.pagination.bulletSize = l.eq(0)[
                            t.isHorizontal()
                                ? "outerWidth"
                                : "outerHeight"
                        ](!0), n.css(
                            ...
                            i.bulletActiveClass + " " + i.bulletActiveClass + "-next " + i.bulletActiveClass +
                            "-next-next " + i.bulletActiveClass + "-prev " + i.bulletActiveClass + "-prev-p" +
                            "rev"
                        ), n.length > 1) 
                            l.each(function (t, a) {
                                var r = e(a);
                                r.index() === s && (
                                    ...
                                    i.dynamicBullets && (r.prev().addClass(
                                        i.bulletActiveClass + "-prev"
                                    ).prev().addClass(i.bulletActiveClass + "-prev-prev"), r.next().addClass(
                                        i.bulletActiveClass + "-next"
                                    ).next().addClass(i.bulletActiveClass + "-next-next"))
                                )
                            });
                        else {
                            var d = l.eq(s);
                            ...
                            i.dynamicBullets && (
                                d.prev().addClass(i.bulletActiveClass + "-prev").prev().addClass(
                                    i.bulletActiveClass + "-prev-prev"
                                ),
                                d.next().addClass(i.bulletActiveClass + "-next").next().addClass(
                    ...
                    if ("fraction" === i.type && (n.find("." + i.currentClass).text(s + 1), n.find(
                        "." + i.totalClass
                    ...
                    "custom" === i.type && i.renderCustom
                        ? (n.html(i.renderCustom(t, s + 1, o)), t.emit("paginationRender", t, n[0]))
            ...
            init: function () {
                ...
                if (a.el) {
                    ...
                    0 !== i.length && (
                        ...
                        i.addClass(
                            a.modifierClass + a.type
                        ),
                        "bullets" === a.type && a.dynamicBullets && i.addClass(
        ...
        j = {
            ...
            on: {
                ...
                click: function (t) {
                    var a = this;
                    a.params.pagination.el && a.params.pagination.hideOnClick && a.pagination.$el.length > 0 && !e(
                        t.target
                    ).hasClass(a.params.pagination.bulletClass) && a
                        .pagination
                        .$el
                        .toggleClass(a.params.pagination.hiddenClass)
                }
            }
        },
        q = {
            ...
            onDragEnd: function (e) {
                ...
                ), t.emit("scrollbarDragEnd", e), a.snapOnRelease && t.slideReset())
            },
            ...
            init: function () {
                ...
                if (t.params.scrollbar.el) {
                    var a = t.scrollbar,
                        ...
                        n = e(r.el);
                    t.params.uniqueNavElements && "string" == typeof r.el && n.length > 1 && 1 === i
                        .find(
                            r.el
                        )
                    ...
                    t.scrollbar.dragEvents = !1 !== t.params.simulateTouch || p.touch
                        ? s
                        : {
                            start: "mousedown",
                            move: "mousemove",
        ...
        Z = {
            ...
            onGestureChange: function (e) {
                ...
                s.$imageEl && 0 !== s.$imageEl.length && (
                    ...
                    i.scale < a.minRatio && (
                        i.scale = a.minRatio + 1 - Math.pow(a.minRatio - i.scale + 1, .5)
                    ),
            ...
            onGestureEnd: function (e) {
                ...
                s.$imageEl && 0 !== s.$imageEl.length && (
                    ...
                    s.$imageEl.transition(t.params.speed).transform(
            ...
            toggle: function (e) {
                ...
                if (r.$slideEl || (
                    ...
                    i.scale = r
                        .$imageWrapEl
                        .attr("data-swiper-zoom") || s.maxRatio,
                    i.currentScale = r
                        .$imageWrapEl
                        .attr("data-swiper-zoom") || s.maxRatio,
                    t
            ...
            enable: function () {
                ...
                if (!a.enabled) {
                    ...
                    var i = t.slides,
                        s = !(
                            "touchstart" !== t.touchEvents.start || !p.passiveListener || !t.params.passiveListeners
                        ) && {
                            passive: !0,
                            capture: !1
                        };
                    ...
                    t
                        ...
                        .each(function (i, s) {
                            var r = e(s);
                            r
                                .find("." + t.params.zoom.containerClass)
                                .length > 0 && r.on(t.touchEvents.move, a.onTouchMove)
                        })
                }
            },
            disable: function () {
                ...
                if (a.enabled) {
                    ...
                    t
                        ...
                        .each(function (i, s) {
                            ...
                            r
                                .find("." + t.params.zoom.containerClass)
                                .length > 0 && r.off(t.touchEvents.move, a.onTouchMove)
                        })
                }
            }
        },
        Q = {
            ...
            on: {
                ...
                doubleTap: function (e) {
                    var t = this;
                    t.params.zoom.enabled && t.zoom.enabled && t.params.zoom.toggle && t
                        .zoom
                        .toggle(e)
                },
        ...
        J = {
            loadInSlide: function (t, a) {
                ...
                if (void 0 !== t && 0 !== i.slides.length) {
                    ...
                    !r.hasClass(s.elementClass) || r.hasClass(s.loadedClass) || r.hasClass(
                        s.loadingClass
                    ) || (n = n.add(r[0])),
                ...
                return this.interpolate = function (e) {
                    return e
                        ? (
                            s = a(this.x, e),
                            i = s - 1,
                            (e - this.x[i]) * (this.y[s] - this.y[i]) / (this.x[s] - this.x[i]) + this.y[i]
                        )
                        : 0
                },
                this
        ...
        ie = {
            ...
            onEnterKey: function (t) {
                ...
                if (13 === t.keyCode) {
                    var s = e(t.target);
                    a.navigation && a.navigation.$nextEl && s.is(a.navigation.$nextEl) && (
                        a.isEnd && !a.params.loop || a.slideNext(),
                        a.isEnd
                            ? a.a11y.notify(i.lastSlideMessage)
                            : a.a11y.notify(i.nextSlideMessage)
                    ),
                    a.navigation && a.navigation.$prevEl && s.is(a.navigation.$prevEl) && (
            ...
            updatePagination: function () {
                var t = this,
                    a = t.params.a11y;
                t.pagination && t.params.pagination.clickable && t.pagination.bullets && t.pagination.bullets.length && t
                    .pagination
                    .bullets
                    .each(function (i, s) {
                        var r = e(s);
                        ...
                        t
                            .a11y
                            .addElLabel(r, a.paginationBulletMessage.replace(/{{index}}/, r.index() + 1))
                    })
            },
            init: function () {
                var e = this;
            ...
            destroy: function () {
                var e = this;
                e.a11y.liveRegion && e.a11y.liveRegion.length > 0 && e
                    .a11y
                    .liveRegion
                    .remove();
                var t,
                ...
                e.pagination && e.params.pagination.clickable && e.pagination.bullets && e.pagination.bullets.length && e
                    .pagination
                    .$el
                    .off("keydown", "." + e.params.pagination.bulletClass, e.a11y.onEnterKey)
            }
        },
        se = {
            name: "a11y",
        ...
        re = {
            ...
            destroy: function () {
                var e = this;
                e.params.history.replaceState || s.removeEventListener(
                    "popstate",
        ...
        oe = {
            onHashCange: function () {
                ...
                t !== e
                    .slides
                    .eq(e.activeIndex)
                    .attr("data-hash") && e.slideTo(e.$wrapperEl.children(
            ...
            init: function () {
                ...
                if (!(!t.params.hashNavigation.enabled || t.params.history && t.params.history.enabled)) {
                    ...
                    t.params.hashNavigation.watchState && e(s).on(
                        "hashchange",
                        t.hashNavigation.onHashCange
                    )
                }
            },
            destroy: function () {
                var t = this;
                t.params.hashNavigation.watchState && e(s).off(
                    "hashchange",
                    t.hashNavigation.onHashCange
                )
            }
                ...
                for (var v = 0; v < r.length; v += 1) {
                    ...
                    var S = "rotateX(" + (
                        ...
                        c
                            ? b
                            : 0
                    ) + "deg) translate3d(" + x + "px, " + T + "px, " + E + "px)";
                    if (
                        ...
                        0 === C.length && (C = e('<div class="swiper-slide-shadow-' + (
                            c
                                ? "left"
                                : "top"
                        ) + '"></div>'), f.append(C)),
                        0 === M.length && (M = e('<div class="swiper-slide-shadow-' + (
                            c
                                ? "right"
                                : "bottom"
                        ) + '"></div>'), f.append(M)),
                ...
                if (s.css({
                    ...
                    if (c) 
                        t.transform(
                            "translate3d(0px, " + (
                                n / 2 + p.shadowOffset
                            ) + "px, " + -n / 2 + "px) rotateX(90deg) rotateZ(0deg) scale(" + p.shadowScale + ")"
                        );
                    else {
                        var z = Math.abs(h) - 90 * Math.floor(Math.abs(h) / 90),
                            ...
                            I = p.shadowOffset;
                        t.transform(
                            "scale3d(" + k + ", 1, " + $ + ") translate3d(0px, " + (
                                o / 2 + I
                            ) + "px, " + -o / 2 / $ + "px) rotateX(-90deg)"
                        )
                    }
                var L = m.isSafari || m.isUiWebView
                    ? -d / 2
                    : 0;
                s.transform("translate3d(0px,0," + L + "px) rotateX(" + (
                    a.isHorizontal()
                        ? 0
                        : h
                ) + "deg) rotateY(" + (
            ...
            setTranslate: function () {
                for (var t = this, a = t.slides, i = 0; i < a.length; i += 1) {
                    ...
                    if (
                        ...
                        0 === p.length && (p = e('<div class="swiper-slide-shadow-' + (
                            t.isHorizontal()
                                ? "left"
                                : "top"
                        ) + '"></div>'), s.append(p)),
        ...
        ge = {
            setTranslate: function () {
                for (
                    ...
                    Math.abs(w) < .001 && (w = 0),
                    Math.abs(y) < .001 && (y = 0);
                    var S = "translate3d(" + E + "px," + T + "px," + x + "px)  rotateX(" + y + "deg" +
                            ") rotateY(" + w + "deg)";
                    if (
                        f.transform(S),
                        ...
                        C.length && (
                            C[0].style.opacity = b > 0
                                ? b
                                : 0
                        ),
                        M.length && (
                            M[0].style.opacity = -b > 0
                                ? -b
                                : 0
                        )
                    }
...
!function (t, i) {
    ...
    i.fn.filterizr = function () {
        var t = this,
            r = arguments;
        if (t._fltr || (t._fltr = i.fn.filterizr.prototype.init(
            t,
            "object" == typeof r[0]
                ? r[0]
                : void 0
    ...
    i.fn.filterizr.prototype = {
        ...
        toggleFilter: function (t) {
            ...
            i._multifilterModeOn()
                ...
                : (i.filter("all"), i._isSearchActivated() && i.search(i._typedText))
        },
        search: function (t) {
            var i = this,
            ...
            if (i._isSearchActivated()) 
                for (e = 0; e < r.length; e++) 
                    r[e]
                        .text()
                        .toLowerCase()
                        .indexOf(t.toLowerCase()) > -1 && n.push(r[e]);
            if (n.length > 0) 
                i._handleFiltering(n);
            ...
            if (i._mainArray && (t.animationDuration || t.delay || t.easing || t.delayMode)) 
                for (r = 0; r < i._mainArray.length; r++) 
                    i
                        ...
                        .css(
                            "transition",
                            "all " + i.options.animationDuration + "s " + i.options.easing + " " + i._mainArray[r]._calcDelay() +
                                    "ms"
                        );
            t.callbacks && (
        ...
        _makeMultifilterArray: function () {
            for (var t = this, i = [], r = {}, n = 0; n < t._mainArray.length; n++) {
                ...
                if (Array.isArray(e._category)) {
                    ...
                    e._category in t._toggledCategories && (o = !0);
    ...
    var n = {
        ...
        _calcDelay: function () {
            var t = this,
                i = 0;
            return "progressive" === t._parent.options.delayMode
            ...
            if ("string" == typeof i) {
                ...
                for (var r = 0; r < i.length; r++) {
                    if (isNaN(parseInt(i[r]))) 
                        throw new Error(
                            "Filterizr: the value of data-category must be a number, starting from value 1 " +
                            "and increasing."
                        );
        ...
        _onTransitionEnd: function () {
            var t = this;
            t._filteringOut
                ? (i(t).addClass("filteredOut"), t._isFilteredOut = !0, t._filteringOut = !1)
        ...
        _filterOut: function () {
            var t = this,
                i = t
                    ._parent
                    ._makeDeepCopy(t._parent.options.filterOutCss);
        ...
        _filterIn: function (t) {
            var r = this,
                n = r
                    ._parent
                    ._makeDeepCopy(r._parent.options.filterInCss);
...
(function (v, p) {
    ...
    var ga = {
        ...
        V = (
            "translateX translateY translateZ rotate rotateX rotateY rotateZ scale scaleX s" +
            "caleY scaleZ skewX skewY"
        ).split(" "),
        E,
        g = {
            arr: function (a) {
...
function UGFunctions() {
    ...
    this.getImageInsideParentData = function (e, t, i, n, r, o, a) {
        ...
        if (t > 0 && i > 0) {
            if ("down" == n && o > t && a > i) 
                ...
                l = u * c,
                o > l
                    ? (l = o, u = l / c, _ = 0, d = Math.round((u - a) / 2 * -1))
    ...
    this.zoomImageInsideParent = function (e, t, n, r, o, a, s) {
        ...
        if (1 == t) 
            ...
            if (u < E.imageWidth) 
                return i.scaleImageFitParent(e, p.width, p.height, o, s),
                !0;
    ...
    this.scaleImageFitParent = function (e, t, n, r, o) {
        var a = e.parent(),
            ...
            l = !1,
            u = {};
        return null !== s.imageWidth && (
            l = !0,
            e.removeAttr("width"),
            u.width = s.imageWidth + "px"
        ),
        null != s.imageHeight && (
            l = !0,
            e.removeAttr("height"),
            u.height = s.imageHeight + "px"
        ),
    ...
    this.handleScrollTop = function (e) {
        ...
        if (null === t.scrollDir && (
            Math.abs(t.diffMouseX) > r
                ? t.scrollDir = "hor"
                : Math.abs(t.diffMouseY) > o && Math.abs(t.diffMouseY) > Math.abs(t.diffMouseX) && (
                    t.scrollDir = "vert",
    ...
    this.getArrTouches = function (e) {
        var t = [];
        return e.originalEvent && e.originalEvent.touches && e.originalEvent.touches.length > 0 && (
    ...
    this.whenContiniousEventOver = function (e, t, i) {
        ...
        1 == n
            .timeCache
            .hasOwnProperty(e) && null != n
            .timeCache[e] && (clearTimeout(n.timeCache[e]), n.timeCache[e] = null),
...
function UGThumbsGeneral() {
    function e(e, t) {
        ...
        return C.isEffectBorder && u.append(
            "<div class='ug-thumb-border-overlay'></div>"
        ),
    ...
    function n(e, t, i) {
        ...
        t
            ? n
                .stop(!0)
                .fadeTo(r, C.colorOverlayOpacity)
            : n
                .stop(!0)
                .fadeTo(r, 0)
    }
    function r(e, t, i) {
        ...
        t
            ? r
                .stop(!0)
                .fadeTo(o, 1)
            : (n.fadeTo(0, 1), r.stop(!0).fadeTo(o, 0))
    }
    function o(e, t) {
        if (
            C.isEffectBorder && i(e, j.thumb_selected_border_width, j.thumb_selected_border_color, t),
            C.isEffectOverlay
        ) {
            var o = 1 == j.thumb_overlay_reverse
                ? !0
                : !1;
            n(e, o, t)
        }
    ...
    function u(e) {
        1 == c(e)
            ? o(e, !0, "redraw")
            : T.setThumbNormalStyle(e, !0, "redraw")
    }
    function d(e, i, n) {
            ...
            .length
                ...
                : (
                    ...
                    1 == objItem.isLoaded && t === !1
                        ? !1
                        : (T.triggerImageLoadedEvent(n, i), void(
                            1 == C.customThumbs
    ...
    this.setThumbNormalStyle = function (e, t, o) {
        if (
            ...
            var a = 1 == j.thumb_overlay_reverse
                ? !1
                : !0;
            n(e, a, t)
        }
    ...
    this.setThumbOverStyle = function (e) {
        if (
            ...
            C.isEffectBorder && i(e, j.thumb_over_border_width, j.thumb_over_border_color),
            C.isEffectOverlay
        ) {
            var t = 1 == j.thumb_overlay_reverse
                ? !0
                : !1;
            n(e, t)
        }
    ...
    this.setThumbSelected = function (e) {
        ...
        1 == c(e)
            ? !0
            : (e.addClass("ug-thumb-selected"), void o(e))
    },
...
function UGThumbsStrip() {
    ...
    function n() {
        ...
        s(),
        0 == R.isRunOnce && (
            1 == k.strip_control_touch && (M = new UGTouchThumbsControl, M.init(O)),
    ...
    function r(e) {
        G.stripSize = e,
        0 == H
            ? G.stripActiveSize = G.stripSize - k.strip_padding_left - k.strip_padding_right
            : G.stripActiveSize = G.stripSize - k.strip_padding_top - k.strip_padding_bottom,
    ...
    function I() {
        return G.stripInnerSize > G.stripActiveSize
            ? !0
            : !1
    }
    function w() {
    ...
    this.positionInnerStrip = function (e, t) {
        ...
        0 == t
            ...
            : (O.triggerStripMoveEvent(), C.stop(!0).animate(i, {
    ...
    this.resize = function (e) {
        0 == H
            ? (
                j.width(e),
                G.stripActiveSize = e - k.strip_padding_left - k.strip_padding_right
            )
            : (
                j.height(e),
                G.stripActiveSize = e - k.strip_padding_top - k.strip_padding_bottom
            ),
        r(e),
        p(),
        h(),
...
function UGTouchThumbsControl() {
    ...
    function o() {
        ...
        t >= E.touch_portion_time && (
            ...
            T.lastDeltaTime > E.touch_portion_time && (T.lastDeltaTime = E.touch_portion_time),
    ...
    this.isSignificantPassed = function () {
        var t = e();
        return t.passedTime > 300
            ? !0
            : t.passedDistanceAbs > 30
                ? !0
                : !1
    },
...
function UGPanelsBase() {
    ...
    this.setHtml = function (e) {
        ...
        if (
            1 == t && (l = new UGPanelHandle, l.init(r, o, a, n.panelType, d), l.setHtml()),
    ...
    this.openPanel = function (a) {
        ...
        return o.is(":animated")
            ...
            : 0 == n.isClosed
                ? !1
                : (n.isClosed = !1, s.trigger(r.events.OPEN_PANEL), void(
                    a === !1
                        ? e(n.originalPos, i)
                        : (t(n.originalPos), i())
                ))
...
function UGPanelHandle() {
    ...
    function r() {
        ...
        switch (e) {
            case "right":
            case "left":
                "top" != u.panel_handle_align && "bottom" != u.panel_handle_align && (
                    u.panel_handle_align = "top"
                );
                break;
            case "bottom":
                "left" != u.panel_handle_align && "right" != u.panel_handle_align && (
...
function UGStripPanel() {
    ...
    function n(e) {
        ...
        if (
            ...
            1 == j.strippanel_vertical_type && (
                t = "ug-strip-arrow-up",
                i = "ug-strip-arrow-down"
            ),
            b.append(
                "<div class='ug-strip-arrow " + t + " ug-skin-" + j.strippanel_buttons_skin + "'><div class='ug-strip-arrow-tip'></div></div>"
            ),
            b.append(
                "<div class='ug-strip-arrow " + i + " ug-skin-" + j.strippanel_buttons_skin + "'><div class='ug-strip-arrow-tip'></div></div>"
            )
        }
        x.setHtml(b),
        P.setHtml(b),
        1 == j.strippanel_enable_buttons && (I = b.children("." + t), y = b.children(
            "." + i
        )),
        r()
    }
    function r() {
        "" != j.strippanel_background_color && b.css(
            "background-color",
    ...
    function s() {
        0 == j.strippanel_vertical_type
            ? o()
            : a()
    }
    function l() {
        y && (
            S.placeElement(I, "left", "top", j.strippanel_padding_left, j.strippanel_padding_top),
            S.placeElement(y, "right", "top", j.strippanel_padding_right, j.strippanel_padding_top)
        );
    ...
    function u() {
        y && (
            S.placeElement(I, "left", "top", j.strippanel_padding_left, j.strippanel_padding_top),
            S.placeElement(y, "left", "bottom", j.strippanel_padding_left, j.strippanel_padding_bottom)
        );
...
function UGGridPanel() {
    ...
    function n() {
        ...
        L.isHorType
            ? (
                w.append(
                    "<div class='grid-arrow grid-arrow-left-hortype ug-skin-" + M.gridpanel_arrows_skin +
                    "'></div>"
                ),
                w.append(
                    "<div class='grid-arrow grid-arrow-right-hortype ug-skin-" + M.gridpanel_arrows_skin +
                    "'></div>"
                ),
            ...
            : 0 == M.gridpanel_vertical_scroll
                ? (w.append(
                    "<div class='grid-arrow grid-arrow-left ug-skin-" + M.gridpanel_arrows_skin + "'></div>"
                ), w.append(
                    "<div class='grid-arrow grid-arrow-right ug-skin-" + M.gridpanel_arrows_skin +
                    "'></div>"
                ), T = w.children(".grid-arrow-left"), E = w.children(".grid-arrow-right"))
                : (w.append(
                    "<div class='grid-arrow grid-arrow-up ug-skin-" + M.gridpanel_arrows_skin + "'>" +
                    "</div>"
                ), w.append(
                    "<div class='grid-arrow grid-arrow-down ug-skin-" + M.gridpanel_arrows_skin + "'></div>"
                ), T = w.children(".grid-arrow-up"), E = w.children(".grid-arrow-down")),
        A.setHtml(w),
        T.fadeTo(0, 0),
        E.fadeTo(0, 0),
        C.setHtml(w),
    ...
    function r() {
        "" != M.gridpanel_background_color && w.css(
            "background-color",
    ...
    function u() {
        var e = C.getSize();
        1 == L.isHorType
            ? L.panelHeight = e.height + M.gridpanel_padding_border_top + M.gridpanel_padding_border_bottom
            : L.panelWidth = e.width + M.gridpanel_padding_border_left + M.gridpanel_padding_border_right,
    ...
    this.setHeight = function (e) {
        if (1 == L.isHorType) 
            throw new Error(
                "setHeight is not appliable to this orientatio (" + L.orientation + "). Please " +
                "use setWidth"
            );
        L.panelHeight = e;
        var t = a();
    ...
    this.setWidth = function (e) {
        if (0 == L.isHorType) 
            throw new Error(
                "setWidth is not appliable to this orientatio (" + L.orientation + "). Please u" +
                "se setHeight"
            );
        L.panelWidth = e;
        var t = s();
...
function UGThumbsGrid() {
    ...
    function a() {
        ...
        return s < V.grid_min_cols && (
            a = F.getItemSizeInSpace(X.gridWidth, V.grid_min_cols, X.spaceBetweenCols)
        ),
    ...
    function g() {
        ...
        for (i = 0; i < l; i++) {
            ...
            n + _ > X.gridHeight && (
                ...
                t = o,
                r = 0,
                1 == X.isMaxHeight && 1 == X.numPanes && (X.gridHeight = s, G.height(X.gridHeight)),
    ...
    function c() {
        ...
        for (i = 0; i < l; i++) {
            ...
            g > c && (
                1 == X.isMaxHeight && 1 == X.numPanes && (X.gridHeight = r, G.height(X.gridHeight), c = X.gridHeight),
    ...
    function I() {
        return 1 == X.isNavigationVertical
            ? X.gridHeight
            : X.gridWidth
    }
    function w(e) {
    ...
    this.isFirstPane = function () {
        return 0 == X.currentPane
            ? !0
            : !1
    },
    this.isLastPane = function () {
        return X.currentPane == X.numPanes - 1
            ? !0
            : !1
    },
...
function UGTiles() {
    ...
    function t() {
        ...
        0 != de.tiles_max_columns && de.tiles_max_columns < de.tiles_min_columns && (
    ...
    function n() {
        if (
            ...
            var e = se.getOptions();
            1 == e.tile_enable_image_effect && 0 == e.tile_image_effect_reverse && $.addClass(
                "ug-tiles-transit-overlays"
            ),
            _e.isTransActive = !0
        }
    }
    ...
    function u() {
        if (
            ...
            ue.numCols < ue.minCols
                ...
                : ue.totalWidth = ue.numCols * (ue.colWidth + ue.colGap) - ue.colGap;
        else {
    ...
    function A(e) {
        for (var t = 0, i = 0, n = 0; n < e.length - 1; n++) {
            var r = e[n].sizes,
                o = -1,
                a = -1;
            Q(r.top + r.dimHeight) && ge.maxColumns > r.left + r.dimWidth && (
        ...
        for (var n = 0; n < e.length - 1; n++) {
            var r = e[n].sizes,
                o = -1,
                a = -1;
            Q(r.top + r.dimHeight) && r.left - 1 >= 0 && (
    ...
    function M(e, t, i) {
        var n = ie[e],
            ...
            l = k(e, s, !0),
            u = [];
        return u.push({tileID: e, sizes: l}),
        u
    }
    function O(e) {
    ...
    function z(e, t) {
        ...
        for (var _ = n, g = [], s = r.length - 1; s >= 0; s--) {
            ...
            0 != s
                ? (
                    c = Math.max(Math.round(1 * n / 3), Math.floor(r[s][1] * (n / i))),
                    _ -= c,
                    d = k(l, c, !0),
                    d.left = o,
                    d.top = a,
    ...
    function L(e, t, i) {
        ...
        if (s.push(e), n >= 0) {
            for (o = 0; n >= 0;) {
                if (
                    r = te[n][i],
                    "undefined" != typeof te[n][i - 1] && te[n][i - 1] == te[n][i] || "undefined" != typeof te[n][i + t] && te[n][i + t - 1] == te[n][i + t] || te[n][i] != te[n][i + t - 1]
                ) 
                    return l.push(a),
                    l.push(s),
                    l;
...
function UGTileDesign() {
    ...
    function t() {
        if (
            ...
            1 == B.tile_enable_outline && 0 == B.tile_enable_border && (
    ...
    function n(e, t) {
        if (e.addClass("ug-tile"), Y.funcCustomTileHtml) 
            return Y.funcCustomTileHtml(e, t),
            !1;
        var i = "";
        ...
        r = Q.htmlentitles(r),
        i += '<img src="' + Q.escapeDoubleSlash(t.urlThumb) + "\" alt='" + r + "' class='" +
                n + "'>",
        ...
        if (
            ...
            1 == B.tile_enable_border && (
                ...
                B.tile_border_radius && (o["border-radius"] = B.tile_border_radius + "px")
            ),
        ...
        var _ = Y.isSaparateIcons;
            if (
                0 == _ && "image" != t.type && 1 == Y.isVideoplayIconAlwaysOn && (_ = !0),
                _
            ) 
                var g = e;
            else 
        ...
        if (1 == B.tile_enable_image_effect) {
            ...
            f += '<img src="' + Q.escapeDoubleSlash(t.urlThumb) + "\" alt='" + t.title + "' clas" +
                    "s='" + m + p + "'>",
            f += "</div>",
            e.append(f),
            1 == B.tile_image_effect_reverse && e
                .children(".ug-tile-image-overlay")
                .fadeTo(0, 0)
        }
            ...
            case R.sizeby.IMAGE_RATIO:
                ...
                if ("undefined" != typeof i.thumbRatioByHeight) {
                    if (0 == i.thumbRatioByHeight) 
                        throw trace(i),
                        new Error("the item ratio not inited yet");
    ...
    function v(e) {
        return 1 == B.tile_enable_icons && 1 == Y.isVideoplayIconAlwaysOn && "image" != e.type
            ? !0
            : !1
    }
    function b(e, t, i, n) {
        ...
        if (0 == B.tile_enable_image_effect) 
            ...
            var h = "nothing";
            n === !0 && 0 == Y.isTextpanelOutside && (
                h = 1 == B.tile_image_effect_reverse
                    ? "effect"
                    : "image"
            ),
            "effect" != h && (
            ...
            "image" != h && (
                1 == Y.hasImageContainer
                    ? Q.scaleImageCoverParent(l, t, i)
                    : "effect" == h
                        ? (Q.scaleImageCoverParent(l, t, i), null !== d && Q.placeElement(l, 0, d))
    ...
    function w(e, t) {
        ...
        if (0 == B.tile_image_effect_reverse) {
            ...
            t
                ? (o.fadeTo(0, 1), i.stop(!0).fadeTo(n, 0))
                : i
                    .stop(!0)
                    .fadeTo(n, 1)
        } else 
    ...
    function S(e, t) {
        if (
            ...
            1 == B.tile_enable_textpanel && 0 == B.tile_textpanel_always_on && 0 == Y.isTextPanelHidden && E(t, !0),
    ...
    function P(e, t) {
        if (
            ...
            1 == B.tile_enable_textpanel && 0 == B.tile_textpanel_always_on && E(t, !1),
    ...
    function j(e, t, i) {
        return t = jQuery(t),
        1 == B.tile_visible_before_image && t.data("image_placed") !== !0 && i !== !0
            ? !0
        ...
        switch (Q.setElementSize(e, t, i), n) {
            ...
            case R.resizemode.VISIBLE_ELEMENTS:
                if (Y.funcCustomTileHtml) 
                    return R.triggerSizeChangeEvent(e, !0),
                    !0;
                b(e, t, i, !0),
                1 == B.tile_enable_textpanel && 1 == B.tile_textpanel_always_on && t && y(
                    e,
                    "regular",
                    t,
                    i
    ...
    this.resizeAllTiles = function (e, t, n) {
        ...
        var r = null;
        if (
            B.tile_size_by == R.sizeby.GLOBAL_RATIO && (r = R.getTileHeightByWidth(e)),
            !n
        ) 
            var n = W.getThumbs();
        n.each(function (i, n) {
    ...
    this.run = function (e) {
        ...
        var i = W.getThumbs(t);
        B.tile_size_by == R.sizeby.GLOBAL_RATIO && R.resizeAllTiles(
            B.tile_width,
            R.resizemode.WRAPPER_ONLY,
            i
        ),
        1 == B.tile_enable_image_effect && 0 == B.tile_image_effect_reverse && i
            .children(
                ".ug-thumb-image"
            )
            .fadeTo(0, 0),
    ...
    this.getTileHeightByWidth = function (e, t) {
        ...
        return t && 1 == Y.isTextpanelOutside && B.tile_size_by == R.sizeby.IMAGE_RATIO && (
            n += g(t)
        ),
        n
    },
...
function UGAviaControl() {
    ...
    function t(t) {
        jQuery("body").on("touchstart", function (e) {
            return 0 == f.isControlEnabled
                ? !0
                : void(f.touchEnabled = !0)
        }),
        jQuery("body").mousemove(function (t) {
            if (0 == f.isControlEnabled) 
                return !0;
            if (1 == f.touchEnabled) 
                return jQuery("body").off("mousemove"),
                !0;
...
function UGSlider() {
    ...
    function r(e) {
        ...
        if (
            ...
            1 == Se.slider_enable_arrows && (
                i += "<div class='ug-slider-control ug-arrow-left ug-skin-" + Se.slider_arrows_skin +
                            "'></div>",
                i += "<div class='ug-slider-control ug-arrow-right ug-skin-" + Se.slider_arrows_skin +
                            "'></div>"
            ),
            1 == Se.slider_enable_play_button && (i += "<div class='ug-slider-control ug-button-play ug-skin-" + Se.slider_play_button_skin +
                    "'></div>"),
            1 == Se.slider_enable_fullscreen_button && (i += "<div class='ug-slider-control ug-button-fullscreen ug-skin-" + Se.slider_fullscreen_button_skin +
                    "'></div>"),
            i += "</div>",
            ie.append(i),
            ...
            var r = Ee.getType();
            "bar" == r && "pie" == Se.slider_progress_indicator_type && (
    ...
    function a() {
        if (ye && (objBullets = ye.getElement(), we.placeElement(
            objBullets,
            ...
            Se.slider_bullets_offset_hor,
            Se.slider_bullets_offset_vert
        )), 1 == Se.slider_enable_arrows && (we.placeElement(
            ue,
        ...
        )), 0 == Se.slider_controls_always_on && M(!0), Ee) {
            var e = Ee.getElement();
    ...
    function l() {
        ...
        e = t,
        i
            ? (e = t + r.objNextSlide.outerWidth(), r.objPrevSlide.css("z-index", 2))
            : r
                .objNextSlide
                .hide(),
        r
    ...
    function c(e, t, i) {
        ...
        "image" != t && 1 == Se.slider_video_constantsize && (
    ...
    function p(e, t, i) {
        ...
        if ("undefined" == typeof t.urlImage || "" == t.urlImage) 
            throw new Error(
                "The slide don't have big image defined ( data-image='imageurl' ). Please check" +
                        " gallery items.",
                "showbig"
            );
        var o = t.urlImage,
        ...
        if (objPadding = pe.getObjImagePadding(), a == o && i !== !0) {
            ...
            var g = {};
            g = "image" != l && 1 == Se.slider_video_constantsize
                ? h(u, t)
                : we.scaleImageFitParent(u, t.imageWidth, t.imageHeight, s, objPadding),
            c(u, l, g),
            fe.trigger(pe.events.AFTER_PUT_IMAGE, e)
        } else if (
            u = we.placeImageInsideParent(o, n, t.imageWidth, t.imageHeight, s, objPadding),
            ...
            u.on("load", function () {
                ...
                "image" != n && 1 == Se.slider_video_constantsize
                    ? h(e, s)
                    : l = we.scaleImageFitParent(e, s.imageWidth, s.imageHeight, a, o),
                e.fadeTo(0, 1),
                c(e, n, l),
    ...
    function f(e, t) {
        try {
            ...
            e.data("type", t.type),
            1 == Se.slider_enable_links && "image" == t.type && (
                t.link
            ...
            throw "undefined" != typeof r.fileName && "showbig" == r.fileName && me.showErrorMessageReplaceGallery(
                r.message
            ),
            i.html(""),
            new Error(r)
    ...
    function I() {
        ...
        if (1 == Se.slider_video_constantsize) {
            ...
            n += Se.slider_video_padding_left,
            r += Se.slider_video_padding_top;
        Ie.setPosition(n, r)
    }
    function w() {
    ...
    function x() {
        ...
        1 == Se.slider_zoompanel_mobilehide && ce && ce
            .getElement()
            .hide()
    }
    function j() {
    ...
    function M(e) {
        ...
        e === !0
            ...
            : t
                .stop()
                .fadeTo(Se.slider_controls_appear_duration, 0, function () {
                    t.hide()
                }),
    ...
    function R() {
        ...
        return t
            ...
            : void(
                0 == Se.slider_controls_always_on && 1 == Se.slider_controls_appear_ontap && 1 == pe.isCurrentSlideType("image") && (
                    z(),
                    Te && 1 == Se.slider_textpanel_always_on && pe.isCurrentSlideType("image") && pe.isCurrentSlideImageFit() && v()
                )
            )
    }
    function G(e) {
    ...
    this.refreshSlideItems = function () {
        return 1 == pe.isAnimating()
            ? !0
            : (u(ae), u(se), u(le), void l())
    },
...
function UGTextPanel() {
    ...
    function r(e, t) {
        ...
        if (1 == t) {
            ...
            l
                .add(c)
                .animate(n, v.textpanel_fade_duration)
        } else 
            g && g.height(e),
            l
                .add(c)
    ...
    this.setText = function (e, t) {
        1 == b.isFirstTime
            ...
            : c
                .stop()
                .fadeTo(v.textpanel_fade_duration, 0, function () {
                    p.setTextPlain(e, t),
...
function UGZoomButtonsPanel() {
    function e(e) {
        return e
            ? e.hasClass("ug-zoompanel-button-disabled")
                ? !0
                : !1
            : !0
    }
    ...
    this.appendHTML = function (e) {
        ...
        t += "<div class='ug-zoompanel-button ug-zoompanel-minus ug-zoompanel-button-disable" +
                "d'></div>",
        t += "<div class='ug-zoompanel-button ug-zoompanel-return ug-zoompanel-button-disabl" +
                "ed'></div>",
        t += "</div>",
        e.append(t),
...
function UGProgressPie() {
    ...
    this.put = function (e, t) {
        ...
        e.append(
            "<canvas class='ug-canvas-pie' width='" + a.slider_progresspie_width + "' heigh" +
            "t='" + a.slider_progresspie_height + "'></canvas>"
        ),
...
function UGTouchSliderControl() {
    ...
    function o(e) {
        ...
        if (
            0 == b.isDragging && (b.isDragging = !0, p.trigger(m.events.START_DRAG)),
            h.css("left", o + "px"),
            1 == b.isDragVideo
        ) {
            var u = o - b.startPosx,
...
function UGZoomSliderControl() {
    ...
    function r(e, t, i) {
        ...
        if (i === !0) {
            ...
            return !1;
        return T.isElementBiggerThenParent(e)
            ? !0
            : !1
    }
    function o(e) {
        ...
        1 == P.panYActive
            ? r.top > 0
                ...
                : r.bottom < P.objParentSize.height && (
                    n = P.objParentSize.height - r.height,
                    t = !0
                )
        ...
        1 == P.panXActive
            ? r.left > 0
                ...
                : r.right < P.objParentSize.width && (
                    i = P.objParentSize.width - r.width,
                    e = !0
                )
    ...
    function h() {
        ...
        if (e.width < P.objFitImageSize.imageWidth) {
            P
                .objImage
                .css({position: "absolute", margin: "none"});
            var t = {
...
function UGWistiaAPI() {
    ...
    function t(e, t, n, o, a) {
        ...
        s = !1;
        var l = e + "_video",
            u = "<div id='" + l + "' class='wistia_embed' style='width:" + n + ";height:" +
                    o + ";' data-video-width='" + n + "' data-video-height='" + o +
                    "'>&nbsp;</div>";
        jQuery("#" + e).html(u),
        r = Wistia.embed(t, {
            version: "v1",
    ...
    this.putVideo = function (i, r, o, a, s) {
        return e()
            ? (t(i, r, o, a, s), !0)
            : (this.loadAPI(), void(n = setInterval(function () {
...
function UGSoundCloudAPI() {
    ...
    function t(e, t, n, a, s) {
        ...
        g_isPlayerReady = !1;
        var l = e + "_iframe",
            u = location.protocol + "//w.soundcloud.com/player/?url=http://api.soundcloud.c" +
                    "om/tracks/" + t;
        u += "&amp;buying=false&amp;liking=false&amp;download=false&amp;sharing=false&amp;sh" +
                "ow_artwork=true&show_comments=false&amp;show_playcount=true&amp;show_user=fals" +
                "e&amp;hide_related=true&amp;visual=true&amp;start_track=0&amp;callback=true",
        u += s === !0
            ? "&amp;auto_play=true"
            : "&amp;auto_play=false";
        var d = "<iframe id='" + l + "' src=" + u + " width='" + n + "' height='" + a +
                "' frameborder='0' scrolling='no' webkitallowfullscreen mozallowfullscreen allo" +
                "wfullscreen></iframe>";
        jQuery("#" + e).html(d),
        r = SC.Widget(l),
...
function UGHtml5MediaAPI() {
    ...
    function t(e, t, n, o, a) {
        r = null,
        g_isPlayerReady = !1;
        var s = location.protocol + "//cdnjs.cloudflare.com/ajax/libs/mediaelement/2.18" +
                    ".1/flashmediaelement-cdn.swf",
            l = location.protocol + "//cdnjs.cloudflare.com/ajax/libs/mediaelement/2.18.1/s" +
                    "ilverlightmediaelement.xap",
            u = e + "_video",
            d = "";
        a && a === !0 && (d = "autoplay='autoplay'");
        var _ = "";
        t.posterImage && (_ = "poster='" + t.posterImage + "'");
        var g = "<video id='" + u + "' width='" + n + "' height='" + o + "'  controls='" +
                "controls' preload='none' " + d + " " + _ + ">";
        "" != t.mp4 && (g += "<source type='video/mp4' src='" + t.mp4 + "' />"),
        "" != t.webm && (g += "<source type='video/webm' src='" + t.webm + "' />"),
        "" != t.ogv && (g += "<source type='video/ogg' src='" + t.ogv + "' />"),
        g += "<object width='" + n + "' height='" + o + "' type='application/x-shockwave-fla" +
                "sh' data='" + s + "'>",
...
function UGVimeoAPI() {
    ...
    function t(e, t, n, o, a) {
        ...
        var d = "<iframe src=" + u + " width='" + n + "' height='" + o + "' frameborder" +
...
function UGYoutubeAPI() {
    ...
    function n() {
        if ("function" != typeof s.getPlayerState) 
            return trace("Youtube API error: can't get player state"),
            !1;
    ...
    this.putVideo = function (i, n, o, a, s) {
        return t()
            ? (e(i, n, o, a, s), !0)
            : (this.loadAPI(), void(r = setInterval(function () {
...
function UGVideoPlayer() {
    ...
    this.setHtml = function (e) {
        ...
        t += "<div class='ug-videoplayer-wrapper ug-videoplayer-youtube' style='display:none" +
                "'><div id='" + T.youtubeInnerID + "'></div></div>",
        t += "<div id='" + T.vimeoPlayerID + "' class='ug-videoplayer-wrapper ug-videoplayer" +
                "-vimeo' style='display:none'></div>",
        t += "<div id='" + T.html5PlayerID + "' class='ug-videoplayer-wrapper ug-videoplayer" +
                "-html5'></div>",
        t += "<div id='" + T.soundCloudPlayerID + "' class='ug-videoplayer-wrapper ug-videop" +
                "layer-soundcloud'></div>",
        t += "<div id='" + T.wistiaPlayerID + "' class='ug-videoplayer-wrapper ug-videoplaye" +
                "r-wistia'></div>",
        0 == T.standAloneMode && 1 == E.video_enable_closebutton && (
    ...
    this.show = function () {
        return 1 == h.isVisible()
            ? !0
            : (s.show(), s.fadeTo(0, 1), _ && _.show(), void p.trigger(h.events.SHOW))
    },
    this.hide = function () {
    ...
    this.pause = function () {
        ...
        return null == e
            ? !1
            : void("function" == typeof e.pause && e.pause())
    },
...
function ugCheckForMinJQueryVersion() {
    ...
    if (0 == e) 
        throw new Error(
            "The gallery can run from jquery 1.8 You have jQuery " + jQuery.fn.jquery + " P" +
            "lease update your jQuery library."
        )
}
function ugCheckForErrors(e, t) {
    ...
    function n() {
        if ("function" == typeof jQuery.fn.unitegallery) 
            return !0;
        var e = "You have some jquery.js library include that comes after the gallery files js " +
                "include.";
        throw e += "<br> This include eliminates the gallery libraries, and make it not work.",
        "cms" == t
            ? (
                e += "<br><br> To fix it you can:<br>&nbsp;&nbsp;&nbsp; 1. In the Gallery Settings -" +
                        "> Troubleshooting set option:  <strong><b>Put JS Includes To Body</b></strong>" +
                        " option to true.",
                e += "<br>&nbsp;&nbsp;&nbsp; 2. Find the double jquery.js include and remove it."
            )
            : e += "<br><br> Please find and remove this jquery.js include and the gallery will wo" +
                    "rk. <br> * There should be only one jquery.js include before all other js incl" +
                    "udes in the page.",
        new Error(e)
    }
    try {
        ...
        if (
            ...
            o = "<div style='font-size:16px;color:#BC0C06;max-width:900px;border:1px solid red;" +
                    "padding:10px;'>" + o + "</div>",
            "jquery" == t
        ) {
...
function UniteGalleryMain() {
    ...
    function checkForStartupErrors() {
        ...
        "object" == typeof g_objWrapper.outerWidth() && throwErrorShowMessage(
            "You have some buggy script. most chances jquery-ui.js that destroy jquery oute" +
            "rWidth, outerHeight functions. The gallery can't run. Please update jquery-ui." +
            "js to latest version."
        ),
        setTimeout(function () {
    ...
    function runGallery(e, i, n, r) {
        ...
        if (o && (g_temp.objCustomOptions = i), 1 == g_temp.isRunFirstTime) {
            if (
                ...
                return trace("div with id: " + g_galleryID + " not found"),
                !1;
            g_objParent = g_objWrapper.parent(),
            checkForStartupErrors(),
            g_temp.originalOptions = jQuery.extend({}, g_options),
            o && (g_options = jQuery.extend(g_options, i)),
            1 == g_options.gallery_enable_cache && g_options.gallery_initial_catid && cacheItems(
            ...
            if (
                ...
                return showErrorMessage("No items in this category", ""),
                !1;
            g_objWrapper.html(n);
            var a = g_objWrapper.children();
            fillItemsArray(a),
        ...
        1 == g_temp.isRunFirstTime && 1 == g_options.gallery_enable_tabs && (
            g_objTabs = new UGTabs,
            g_objTabs.init(t, g_options)
        ),
        1 == g_temp.isRunFirstTime && 1 == g_options.gallery_enable_loadmore && (
    ...
    function showErrorMessage(e, t) {
        if ("undefined" == typeof t) 
            ...
            t = "<b>" + t + ": </b>";
        e = t + e;
        var i = "<div class='ug-error-message-wrapper'><div class='ug-error-message'>" +
                e + "</div></div>";
        g_objWrapper
            .children()
            .remove(),
    ...
    function modifyInitParams() {
        ...
        (
            void 0 == g_options.gallery_min_height || g_options.gallery_height < g_options.gallery_min_height
        ) && (g_options.gallery_min_height = 0),
        (
            void 0 == g_options.gallery_min_width || g_options.gallery_width < g_options.gallery_min_width
    ...
    function validateParams() {
        ...
        if (jQuery.isNumeric(g_options.gallery_height) && g_options.gallery_height < g_options.gallery_min_height) 
            throw new Error(
                "The <b>gallery_height</b> option must be bigger then <b>gallery_min_height opt" +
                "ion</b>"
            );
        if (g_options.gallery_width < g_options.gallery_min_width) 
            throw new Error(
                "The <b>gallery_width</b> option must be bigger then <b>gallery_min_width optio" +
                "n</b>"
            )
    }
    ...
    function fillItemByChild(e) {
        ...
        if (a.type = o, "img" == n) {
            ...
            if ("image" == o) 
                throw trace("Problematic gallery item found:"),
                trace(e),
                trace(
                    "Please look for some third party js script that could add this item to the gal" +
                    "lery"
                ),
        ...
        var c = e.data("width"),
            h = e.data("height");
        c && "number" == typeof c && h && "number" == typeof h && (
            a.thumbWidth = c,
            a.thumbHeight = h,
    ...
    function preloadBigImages() {
        if (
            "visible" != g_options.gallery_images_preload_type || g_objThumbs || (g_options.gallery_images_preload_type = "minimal"),
    ...
    function onFullScreenChange() {
        var e = g_functions.isFullScreen(),
            i = e
                ? t.events.ENTER_FULLSCREEN
                : t.events.EXIT_FULLSCREEN,
    ...
    function unselectSeletedItem() {
        return null == g_selectedItem
            ? !0
            : (
                g_objThumbs && g_objThumbs.setThumbUnselected(g_selectedItem.objThumbWrapper),
                g_selectedItem = null,
    ...
    this.resetPlaying = function () {
        return 0 == g_temp.isPlayMode
            ? !0
            : (g_temp.playTimePassed = 0, void(g_temp.playTimeLastStep = jQuery.now()))
    },
    ...
    this.continuePlaying = function () {
        return 0 == g_temp.isPlayModePaused
            ...
            : (
                g_temp.isPlayModePaused = !1,
                g_temp.playTimeLastStep = jQuery.now(),
                void(g_temp.playHandle = setInterval(advanceNextStep, g_temp.playStepInterval))
            )
    },
    ...
    this.addItems = function (e) {
        ...
        0 == t.length && g_objWrapper.append(
    ...
    this.run = function (e, t) {
        ...
        if (
            t && t.hasOwnProperty("gallery_debug_errors") && (g_options.gallery_debug_errors = t.gallery_debug_errors),
...
function UGLightbox() {
    ...
    function t() {
        1 == se.isCompact && 1 == ae.lightbox_show_textpanel && (
            ae.lightbox_slider_image_padding_bottom = se.initTextPanelHeight
        ),
        1 == se.isCompact && "inside" == ae.lightbox_arrows_position && (
            se.isArrowsInside = !0
        ),
        1 == se.isArrowsInside && 0 == ae.lightbox_arrows_inside_alwayson && (
    ...
    function i() {
        ...
        0 == se.isCompact && 1 == se.isTopPanelEnabled && (
    ...
    function _(e) {
        ...
        0 == a && (
            ...
            oe && (oe.positionPanel(se.textPanelTop, se.textPanelLeft), e === !0 && (e(), j()))
        )
    }
    function g() {
    ...
    function c(e, t) {
        ...
        if (
            ...
            var s = ne.getSlideImage(),
                ...
                n = (
                    ...
                    re.getElementRelativePos(Z, "left", 0, s) + l.left + ae.lightbox_arrows_inside_offset
                ),
        ...
        if (t === !0) {
            ...
            Z
                .stop()
                .animate(u, {duration: se.fadeDuration}),
            q
                .stop()
                .animate(d, {duration: se.fadeDuration})
        } else 
            Z.stop(),
            q.stop(),
            re.placeElement(Z, n, r),
            re.placeElement(q, o, a);
    ...
    function h(e, t) {
        ...
        if (t === !0) {
            ...
            K
                .stop()
                .animate(_, {duration: se.fadeDuration})
        } else 
            K.stop(),
            re.placeElement(K, a, o);
        e === !0 && T(t)
    }
    function p() {
        K && K
            .stop()
            .fadeTo(se.fadeDuration, 0),
        v(),
        b(),
            ...
            ? 1 == se.isArrowsOnHoverMode && t === !1
                ...
                : void(
                    e === !0
                        ...
                        : (Z.stop().fadeTo(se.fadeDuration, 0), q.stop().fadeTo(se.fadeDuration, 0))
                )
            : !1
    }
    function w() {
    ...
    function A() {
        ...
        if (se.positionFrom = "onZoomChange", h(!1, !0), c(!1, !0), 1 == se.isCompact) {
            ...
            0 == e
                ? (v(), b())
                : (se.positionFrom = "onZoomChange", x(), j())
        }
    }
    function M() {
        if (0 == se.isCompact) 
    ...
    function L(e, t) {
        0 == se.isCompact
            ? (J && P(t), oe && (
                S(t),
                0 == se.isRightNowOpened && (oe.positionElements(!1), o("onchange"), oe.positionPanel())
            ))
            : 0 == ne.isAnimating() && (oe && S(t), J && P(t)),
        0 == se.isSliderChangedOnce && (
            se.isSliderChangedOnce = !0,
            te.trigger(ee.events.LIGHTBOX_INIT)
        )
    }
    function H(e, t) {
    ...
    this.open = function (e) {
        ...
        if (
            ...
            1 == i
                ? f()
                : 1 == se.isArrowsInside && (Z.hide(), q.hide())
        }
...
function UGCarousel() {
    ...
    function E() {
        var e = -r(),
            ...
            i = B
                ...
                .left,
            n = B
                .getElementSize(u(t + 1))
                .left;
        return Math.abs(i - e) < Math.abs(n - e)
            ? t
            : t + 1
    }
    function T() {
    ...
    function C(e) {
        ...
        var t = null;
        if (
            1 == U.carousel_vertical_scroll_ondrag && (t = B.handleScrollTop(V.storedEventID)),
            "vert" === t
        ) 
            return !0;
        V.lastMousePos = o(e);
        var i = V.lastMousePos - V.startMousePos,
            ...
            a = B
                .getElementSize(G)
                .width;
        n > 0 && "prev" == r && (n /= 3), -a > n && "next" == r && (
            n = V.startInnerPos + i / 3
        ),
        I(n)
    }
    function A(e) {
...
!function (e) {
    ...
    if (e.event.fixHooks) 
        for (var u = a.length; u;) 
            e
                .event
                .fixHooks[a[--u]] = e.event.mouseHooks;
    ...
    function n(t) {
        ...
        h(l, function (e, r) {
            var o,
                ...
                l = r.space || "rgba";
            return s
                ? (o = i[l](s), i[d[l].cache] = o[d[l].cache], n = i._rgba = o._rgba, !1)
                : void 0
        }),
        n.length
                        ...
                        ? (
                            r instanceof u
                                ...
                                : h(d, function (t, n) {
                                    ...
                                    _[o] && e.inArray(null, _[o].slice(0, 3)) < 0 && (_[o][3] = 1, n.from && (
                                        _._rgba = n.from(_[o])
                                    ))
                                }),
                            this
        ...
        h(o, function (t, i) {
            u.fn[t] || (u.fn[t] = function (r) {
                ...
                return "undefined" === a
                    ? d
                    : (
                        "function" === a && (r = r.call(this, d), a = e.type(r)),
                        null == r && i.empty
                            ? this
                            : ("string" === a && (o = s.exec(r), o && (r = d + parseFloat(o[2]) * (
                                "+" === o[1]
                                    ? 1
                                    : -1
                            ))), u[i.idx] = r, this[l](u))
...
function UGTheme_tiles() {
    ...
    function n() {
        ...
        _.append("<div class='ug-tiles-wrapper' style='position:relative'></div>"),
        1 == v.showPreloader && (
    ...
    function a() {
        null !== T.theme_auto_open && (
            f.open(T.theme_auto_open),
            T.theme_auto_open = null
        )
    }
    function u() {
    ...
    a.extend(a.validator, {
        ...
        prototype: {
                ...
                a(this.currentForm)
                    .on(
                        ...
                        ":text, [type='password'], [type='file'], select, textarea, [type='number'], [t" +
                                ...
                                "ocal'], [type='range'], [type='color'], [type='radio'], [type='checkbox']",
                        b
                    )
                ...
                if (this.settings.unhighlight) 
                    for (b = 0; c[b]; b++) 
                        this
                            .settings
                            .unhighlight
                            .call(this, c[b], this.settings.errorClass, "");
                else 
            ...
            check: function (b) {
                ...
                for (d in f) {
                    ...
                    try {
                        ...
                        j instanceof TypeError && (
                            j.message += ".  Exception occurred when checking element " + b.id + ", check the '" + e.method +
                                "' method."
                        ),
                        j
                    }
                ...
                if (!h) 
                    return this.objectLength(f) && this
                        .successList
                        .push(b),
                    !0
            },
            ...
            formatAndAdd: function (b, c) {
                ...
                this
                    .errorList
                    .push({message: d, element: b, method: c.method}),
            ...
            showLabel: function (b, c) {
                ...
                g.length
                    ...
                    : (
                        ...
                        d = g,
                        this.settings.wrapper && (d = g.hide().show().wrap(
